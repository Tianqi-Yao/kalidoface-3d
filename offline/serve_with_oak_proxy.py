...
# 默认值对齐 IMU_GPS/config.py 里的 CAM1_IP / CAM2_IP / CAM1_STREAM_PORT / CAM2_STREAM_PORT
DEFAULT_CAM1_IP = "10.95.76.11"
DEFAULT_CAM1_PORT = 8080
DEFAULT_CAM2_IP = "10.95.76.10"
